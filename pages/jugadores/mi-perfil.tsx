...
.jm{min-height:100vh;padding-top:62px;background:#0C0D0B;font-family:var(--font-u),system-ui,sans-serif;color:#e2e8e0;-webkit-font-smoothing:antialiased}
...
.jm-loading p{font-family:var(--font-d),sans-serif;font-size:13px;color:#6b7569}
...
.jm-avatar{width:88px;height:88px;border-radius:50%;flex-shrink:0;overflow:hidden;border:2px solid var(--g6);box-shadow:0 4px 18px rgba(22,163,74,.3)}
...
.jm-logout{background:transparent;border:none;color:#6b7569;font-size:12px;font-family:var(--font-d),sans-serif;letter-spacing:.04em;cursor:pointer;text-decoration:underline;padding:0}
...
.jm-stat-lbl{font-family:var(--font-d),sans-serif;font-size:10px;color:#6b7569;font-weight:700;text-transform:uppercase;letter-spacing:.1em}
...
.jm-record-title{font-family:var(--font-d),sans-serif;font-size:11px;color:#6b7569;font-weight:700;text-transform:uppercase;letter-spacing:.1em;margin-bottom:14px}
...
.jm-section{font-family:var(--font-d),sans-serif;font-size:11px;color:#525a52;font-weight:700;text-transform:uppercase;letter-spacing:.1em;margin-bottom:10px}
...
.jm-soon-row span{font-family:var(--font-d),sans-serif;font-size:10px;color:#4ade8088;text-transform:uppercase;letter-spacing:.1em;font-weight:700;padding:3px 9px;border:1px solid rgba(74,222,128,.2);border-radius:999px}

 ...
 *   - FAB de WhatsApp mantenido inline.
 *
 * Sin cambios (lógica intacta):
 *   - getServerSideProps (tournament + complex + teams + matches).
 *   - useMemo teamsMap / matchesByRound / whatsappUrl.
 *   - Render de hero, strip, CTAs, secciones, equipos, partidos por ronda.
 */
...
const CSS = `
.pt { min-height: 100vh; padding-bottom: 100px; }
